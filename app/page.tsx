  ...
  return (
    <main className="home relative">
      <div className="grid grid-cols-2">
        ...
        <div className="lg:col-span-1 col-span-2 flex justify-center items-center"></div>
        <motion.div initial={{ opacity: 0, x: -400 }}
          ...
          }} className="lg:col-span-1 col-span-2 text-white flex justify-center items-center ">
