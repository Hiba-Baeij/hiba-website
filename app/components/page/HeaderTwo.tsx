...
function HeaderTwo() {
    ...
    return (
        <motion.div initial={{ opacity: 0, x: -400 }}
            ...
            <PBtn className='top-4 -left-2' border={<Image src='/shapes/ovals/oval-blue.svg' height={97} width={200} alt='border' />} onClick={handleButtonClick} text='Download CV' icon={<FaDownload size={20} />}></PBtn>
